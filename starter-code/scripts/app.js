function init() {
  ...
  // A function is run after player's missile-fire input is converted into a grid cell index and a class of "HIT" has been added
  // This function is checking to see if a class of "hit" has been added to all grid cells in a computerShipLocation's array
